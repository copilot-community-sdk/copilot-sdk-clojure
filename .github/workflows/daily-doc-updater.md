...
```bash
bb --config /dev/null script/validate_docs.clj
```
...
3. **Include in the PR description**:
   ...
   - Validation results from `bb --config /dev/null script/validate_docs.clj`
...
- `bb --config /dev/null script/validate_docs.clj` passed
...
- **Validate**: Always run `bb --config /dev/null script/validate_docs.clj` before creating a PR
